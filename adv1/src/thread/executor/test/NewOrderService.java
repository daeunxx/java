...
import thread.executor.test.OldOrderService.AccountingWork;
import thread.executor.test.OldOrderService.InventoryWork;
import thread.executor.test.OldOrderService.ShippingWork;
...
public class NewOrderService {
  ...
  public void order(String orderNo) throws ExecutionException, InterruptedException {
    ...
    Future<Boolean> accountFuture = es.submit(new AccountingWork(orderNo));
